...
<body>
	...
	$results = $conn->query("SELECT * FROM products WHERE category_id='5' ORDER BY id ASC");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
			...
			echo '<div class="product-thumb"><img src="cart4/images/'.$obj->product_img_name.'"></div>';
