...
<body>
	...
	$results = $conn->query("SELECT * FROM products WHERE category_id='2' ORDER BY id ASC");
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
			...
			echo '<div class="product-thumb"><img src="cart1/images/'.$obj->product_img_name.'"></div>';
